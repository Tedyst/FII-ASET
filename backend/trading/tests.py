...
class PositionModelTest(TestCase):
    def setUp(self):
        ...
        self.ticker = Ticker.objects.create(symbol="AAPL", price=Decimal("150.00"))
    ...
    def test_sell_function_updates_sold_at_and_ended_at(self):
        ...
        self.assertAlmostEqual(position.ended_at, timezone.now(), delta=timezone.timedelta(seconds=1))
