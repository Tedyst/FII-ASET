...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ("trading", "0008_historicalsecurity_users_purchased_and_more"),
    ]

    operations = [
        migrations.CreateModel(
            name="ExternalMarketOrder",
            fields=[
                (
                    "id",
                    models.BigAutoField(
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        to="trading.marketorder",
                    ),
                ),
            ],
        ),
        migrations.CreateModel(
            name="ExternalMarketHolding",
            fields=[
                (
                    "id",
                    models.BigAutoField(
                ...
                ("updated_at", models.DateTimeField(auto_now=True)),
                (
                    "external_market_order",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
                        to="trading.externalmarketorder",
                    ),
                ),
            ],
        ),
